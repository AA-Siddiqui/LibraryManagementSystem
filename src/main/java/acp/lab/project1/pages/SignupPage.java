...
public class SignupPage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("<html><div style='text-align: center;'>SIGN UP</div></html>");
        ...
        loginLabel.setText("<html><div style='text-align: center;'>Already have an account?</div></html>");
        ...
        passwordField.setFont(new java.awt.Font("Roboto Condensed", 0, 18)); // NOI18N
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(15, 15, 15, 15);
        jPanel3.add(addressField, gridBagConstraints);
    ...
    private void signupButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_signupButtonActionPerformed
        ...
        try {
            int inserted = con.createStatement().executeUpdate("INSERT INTO UserDetails (UserType, FullName, PhoneNo, Address, Username, Password) Values(" + (acp.lab.project1.LoggedInUser.userType == -1 ? 1 : 3) + ", \'" + nameField.getText() + "\',\'" + phoneField.getText().replace(" ", "") + "\',\'" + addressField.getText() + "\',\'" + usernameField.getText() + "\',\'" + new String(passwordField.getPassword()) + "\');");
