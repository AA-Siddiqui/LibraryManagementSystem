 ...
 * @author addan
 */
public class UserTransactionHistory extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jCheckBox1.setForeground(DefinedColors.whiteColor);
        ...
        jCheckBox2.setForeground(DefinedColors.whiteColor);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UserTransactionHistory.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UserTransactionHistory().setVisible(true);
            }
        });
    }
